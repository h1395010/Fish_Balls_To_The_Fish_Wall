...
import com.example.android.fish_balls_to_the_fish_wall.SlidingMenu.CanvasTransformer;
...
public class CanvasTransformerBuilder {
    ...
    public CanvasTransformer rotate(final int openedDeg, final int closedDeg,
        ...
        mTrans = new CanvasTransformer() {
            public void transformCanvas(Canvas canvas, float percentOpen) {
                mTrans.transformCanvas(Canvas canvas, float percentOpen);
                float f = interp.getInterpolation(percentOpen);
                canvas.rotate((openDeg - closedDeg) * f + closedDeg,
                        px, py);
            }
        };
        return mTrans;
    ...
    public CanvasTransformer contactTransformer(final CanvasTransformer t) {
        initTransformer();
        mTrans = new CanvasTransformer() {
            public void transformCanvas(Canvas canvas, float percentOpen) {
                mTrans.transformCanvas(canvas, percentOpen);
